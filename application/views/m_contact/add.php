<?php echo form_open('m_contact/add',array("class"=>"form-horizontal")); ?>
	
	<div class="form-group">
		<label for="m_con_name" class="col-md-4 control-label">Contact Name</label>
		<div class="col-md-8">
			<input type="text" name="m_con_name" value="<?php echo $this->input->post('m_con_name'); ?>" class="form-control" id="m_con_name" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="m_con_phone" value="<?php echo $this->input->post('m_con_phone'); ?>" class="form-control" id="m_con_phone" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="m_con_email" value="<?php echo $this->input->post('m_con_email'); ?>" class="form-control" id="m_con_email" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="m_con_role" value="<?php echo $this->input->post('m_con_role'); ?>" class="form-control" id="m_con_role" />
		</div>
	</div>
