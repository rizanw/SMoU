<?php echo form_open('m_place/edit/'.$m_place['m_pla_id'],array("class"=>"form-horizontal")); ?>
	<div class="form-group">
		<label for="m_pla_name" class="col-md-4 control-label">Country</label>
		<div class="col-md-8">
			<input type="text" name="m_pla_name" value="<?php echo ($this->input->post('Country Name') ? $this->input->post('m_pla_name') : $m_place['m_pla_name']); ?>" class="form-control" id="m_pla_name" />
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="sta_id" class="form-control">
				...
				{
					$selected = ($stum['sta_id'] == $m_place['sta_id']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="cit_id" class="form-control">
				...
				{
					$selected = ($cit['cit_id'] == $m_place['cit_id']) ? ' selected="selected"' : "";
